  ...
  General: [
    {
      ...
      a: "We are one of very few regional manufacturers that design, engineer, and produce all five major advanced cladding systems (GFRC, GFRP, UHPC, LTGRC, GFRG) under one roof. Our in-house engineering team, CNC mould shop, and 12,000 m2 Sharjah factory allow us to control quality at every stage - something you simply cannot achieve with outsourced fabrication.",
    },
    {
  ...
  Materials: [
    {
      ...
      a: "For highly corrosive coastal exposures, GFRP is our primary recommendation - it contains zero metallic reinforcement and is inherently immune to chloride-induced corrosion. GFRC with a marine-grade admixture package is also viable for decorative applications where GFRP's aesthetic limitations are a constraint.",
    },
    {
    ...
    },
    {
      ...
      a: "Properly specified and installed, our GFRC, UHPC, and GFRP systems carry a 30+ year design life in GCC climatic conditions. Our standard product warranty is 5 years (Design & Supply) or 10 years (Full Facade Partnership). We also offer extended warranty programmes for critical projects.",
    },
    {
    ...
    <section id="faq" className="section-light py-28">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black tracking-tight text-zinc-900 leading-tight mt-4">
            Questions we hear
            <br />
            ...
            >
              {items.map((item, i) => (
                <div key={i}>
                  ...
                  >
                    <span className="font-semibold text-zinc-900 text-base pr-8">{item.q}</span>
                  ...
                  <AnimatePresence initial={false}>
                    {open === i && (
                      ...
                      >
                        <p className="pb-6 text-zinc-500 text-sm leading-relaxed pr-12">{item.a}</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
